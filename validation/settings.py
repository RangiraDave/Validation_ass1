...
EA_DISABLE_MODEL_TRACKING = False
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', '404_errors.log'),
        },
        'application_file': {
        ...
        'easyaudit_file': {
            ...
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs', 'easyaudit.log'),
        },
    },
    'loggers': {
        'django': {
        ...
        'easyaudit': {
            'handlers': ['easyaudit_file'],
            'level': 'DEBUG',
            'propagate': True,
        },
        '__name__': {  # Add this logger for your application logs
